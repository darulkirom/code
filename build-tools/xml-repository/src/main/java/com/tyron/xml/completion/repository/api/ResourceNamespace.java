...
public class ResourceNamespace implements Comparable<ResourceNamespace>, Serializable {
    ...
    public interface Resolver {
        ...
        @Nullable
        default String uriToPrefix(@NotNull String namespaceUri) {
         ...
         */
        @NotNull
        static Resolver fromBiMap(@NotNull BiMap<String, String> prefixes) {
            return new Resolver() {
                @Nullable
                @Override
                public String uriToPrefix(@NotNull String namespaceUri) {
     ...
     */
    @Nullable
    public static ResourceNamespace fromNamespaceUri(@NotNull String uri) {
    ...
    private ResourceNamespace(@NotNull String uri, @Nullable String packageName) {
        this.uri = uri;
    ...
    @Override
    public int compareTo(@NotNull ResourceNamespace other) {
